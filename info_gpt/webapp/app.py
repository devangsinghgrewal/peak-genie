...
st.caption(
    "peak-genie is an AI-powered Peak Knowledge Base QA tool that enables you to analyze documents"
...
class QaApp:
    ...
    def run_qa(self):
        ...
        print(self.query)
        if st.button("Ask"):
            self.result = ask(self.query, load_model(), show_on_webapp=True)
            self.show_qa = True
